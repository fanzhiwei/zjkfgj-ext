...
//            		params : {start:0, limit:15,recordYearMonth:queryDate}
				...
				proxy: new Ext.data.HttpProxy({
					url : 'statistics/dis7?t=' + new Date().getTime()
				}),
                remoteSort: false,
            ...
            this.grid = new Ext.grid.GridPanel({
                ...
                tbar: [{
                    ...
                    listeners: {
                        ...
                        select: function(obj, date) {
                        	App.StatisticsDis7.store.reload({params:{recordYearMonth:document.getElementById("dis7").value.replace("-","")}});
                        },
                ...
                bbar:new Ext.Toolbar({
	                buttons: [new Ext.Button({
	                    text: '导出到Excel',
	                    handler: function() {
	                        var vExportContent = Ext.getCmp("gridIdSS7").getExcelXml();
