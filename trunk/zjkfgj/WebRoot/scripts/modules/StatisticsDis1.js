...
//            		params : {start:0, limit:15,recordYearMonth:queryDate}
				...
				proxy: new Ext.data.HttpProxy({
					url : 'statistics/dis1?t=' + new Date().getTime()
				}),
                remoteSort: false,
            ...
            this.grid = new Ext.grid.GridPanel({
                ...
                tbar: [{
                    ...
                    listeners: {
                        ...
                        select: function(obj, date) {
                        	App.StatisticsDis1.store.reload({params:{recordYearMonth:document.getElementById("dis1").value.replace("-","")}});
                        },
                ...
                bbar:new Ext.Toolbar({
	                buttons: [new Ext.Button({
	                    text: '导出到Excel',
	                    handler: function() {
	                        var vExportContent = Ext.getCmp("gridIdSS1").getExcelXml();
