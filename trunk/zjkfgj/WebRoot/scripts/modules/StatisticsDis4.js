...
//            		params : {start:0, limit:15,recordYearMonth:queryDate}
				...
				proxy: new Ext.data.HttpProxy({
					url : 'statistics/dis2_5?category=3&t=' + new Date().getTime()
				}),
                remoteSort: false,
                ...
                tbar: [{
                    ...
                    listeners: {
                        ...
                        select: function(obj, date) {
                        	App.StatisticsDis4.store.reload({params:{recordYearMonth:document.getElementById("dis4").value.replace("-","")}});
                        },
