...
//            		params : {start:0, limit:15,recordYearMonth:queryDate}
				...
				proxy: new Ext.data.HttpProxy({
					url : 'statistics/dis2_5?category=2&t=' + new Date().getTime()
				}),
                remoteSort: false,
            ...
            this.grid = new Ext.grid.GridPanel({
                ...
                tbar: [{
                    ...
                    listeners: {
                        ...
                        select: function(obj, date) {
                        	App.StatisticsDis3.store.reload({params:{recordYearMonth:document.getElementById("dis3").value.replace("-","")}});
                        },
                ...
                bbar:new Ext.Toolbar({
	                buttons: [new Ext.Button({
	                    text: '导出到Excel',
	                    handler: function() {
	                        var vExportContent = Ext.getCmp("gridIdSS3").getExcelXml();
