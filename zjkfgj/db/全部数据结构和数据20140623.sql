...
#
# Data for the `district_report1` table  (LIMIT 0,500)
#

INSERT INTO `district_report1` (`id`, `userId`, `createTime`, `modifyTime`, `recordYearMonth`, `developerName`, `licenceNo`, `licenceDate`, `projectName`, `location`, `houseNumber`, `houseArea`, `business`, `office`, `other`) VALUES
  (1,6,'2013-10-25 21:14:18','2013-10-25 21:15:00',201310,'桥东区开发商','201310201310','2013-10-25','小项目1','左卫',11,22.00,33.00,44.00,55.00),
  (2,6,'2013-10-25 21:20:37',NULL,201310,'we','qwe','2013-10-22','22','22',22,22.00,2.00,22.00,34.00),
  (3,7,'2013-10-27 11:02:49',NULL,201310,'q','q','2013-10-28','qq','qq',1,2.00,34.00,5.00,6.00);
COMMIT;

#
# Data for the `district_report2_5` table  (LIMIT 0,500)
#

INSERT INTO `district_report2_5` (`id`, `userId`, `createTime`, `modifyTime`, `recordYearMonth`, `developerName`, `projectName`, `startTime`, `completeTime`, `location`, `houseNumber`, `area`, `totalPrice`, `averagePrice`, `category`) VALUES
  (11,7,'2013-10-27 11:04:16',NULL,201310,'1','1','2013-10-11','2013-10-11','11',1,1.00,1.00,1.00,'2');
COMMIT;

#
# Data for the `district_report6` table  (LIMIT 0,500)
#

INSERT INTO `district_report6` (`id`, `userId`, `createTime`, `modifyTime`, `recordYearMonth`, `firstNumber`, `firstArea`, `secondNumber`, `secondArea`, `threeNumber`, `threeArea`, `fourNumber`, `fourArea`) VALUES
  (3,7,'2013-10-27 11:05:15',NULL,201310,1,2.00,3,4.00,5,6.00,67,88.00);
COMMIT;

#
# Data for the `district_report7` table  (LIMIT 0,500)
#

INSERT INTO `district_report7` (`id`, `userId`, `createTime`, `modifyTime`, `recordYearMonth`, `dealNumber`, `dealArea`, `totalPrice`, `averagePrice`) VALUES
  (2,6,'2013-10-25 21:18:34',NULL,201310,2,2.00,34.00,45.00),
  (3,7,'2013-10-27 11:06:48',NULL,201310,1,2.00,34.00,5.00);
COMMIT;
...
INSERT INTO `realestate_develop` (`id`, `areaId`, `userId`, `createTime`, `modifyTime`, `recordYearMonth`, `investHouse`, `investBusiness`, `investOffice`, `investOther`, `financialSourcingInland`, `financialSourcingForeign`, `financialSourcingSelf`, `financialSourcingOther`, `workingAreaHouse`, `workingAreaBusiness`, `workingAreaOffice`, `workingAreaOther`, `newAreaHouse`, `newAreaBusiness`, `newAreaOffice`, `newAreaOther`, `completeAreaHouse`, `completeAreaBusiness`, `completeAreaOffice`, `completeAreaOther`, `saledAreaHouse`, `saledAreaBusiness`, `saledAreaOffice`, `saledAreaOther`, `incomingHouse`, `incomingBusiness`, `incomingOffice`, `incomingOther`, `onsaleAreaHouse`, `onsaleAreaBusiness`, `onsaleAreaOffice`, `onsaleAreaOther`) VALUES
  ...
  (41,1,-1,'2014-03-15 18:47:47',NULL,201402,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00,1.00);
COMMIT;
...
INSERT INTO `t_menu` (`id`, `name`, `image`, `url`, `qtip`, `sort_num`, `parent_id`, `description`) VALUES
  ...
  (19,'区县房管局报送管理','images/plugin.gif','DistrictReport1','区县单位报送管理',3,NULL,'区县房管局报送管理'),
  (20,'颁发商品房预售许可证情况表','images/plugin.gif','DistrictReport1','颁发商品房预售许可证情况表',11,19,'颁发商品房预售许可证情况表'),
  (21,'商品住宅销售备案情况表','images/plugin.gif','DistrictReport2','商品住宅销售备案情况表',12,19,'商品住宅销售备案情况表'),
  (22,'商业营业房销售备案情况表','images/plugin.gif','DistrictReport3','商业营业房销售备案情况表',13,19,'商业营业房销售备案情况表'),
  (23,'办公房销售备案情况表','images/plugin.gif','DistrictReport4','办公房销售备案情况表',14,19,'办公房销售备案情况表'),
  (24,'其它房销售备案情况表','images/plugin.gif','DistrictReport5','其它房销售备案情况表',15,19,'其它房销售备案情况表'),
  (25,'在册私有住宅情况表','images/plugin.gif','DistrictReport6','在册私有住宅情况表',16,19,'在册私有住宅情况表'),
  (26,'二手住宅交易情况表','images/plugin.gif','DistrictReport7','二手住宅交易情况表',17,19,'二手住宅交易情况表'),
  (27,'区县房管局汇总','images/plugin.gif','DistrictCount','区县房管局汇总',20,NULL,'区县房管局汇总'),
  (28,'颁发商品房预售许可证情况汇总表','images/plugin.gif','DistrictCount1','颁发商品房预售许可证情况汇总表',21,27,'颁发商品房预售许可证情况汇总表'),
  (29,'商品房销售情况汇总表','images/plugin.gif','DistrictCount2','商品房销售情况汇总表',22,27,'商品房销售情况汇总表'),
  (30,'登记在册私有住宅汇总表','images/plugin.gif','DistrictCount3','登记在册私有住宅汇总表',23,27,'登记在册私有住宅汇总表'),
  (31,'二手房住宅交易情况汇总表','images/plugin.gif','DistrictCount4','二手房住宅交易情况汇总表',24,27,'二手房住宅交易情况汇总表'),
  (32,'用户报送情况统计','images/plugin.gif','StatisticsDev','用户报送情况统计',30,NULL,'用户报送情况统计'),
  (33,'开发商报送情况','images/plugin.gif','StatisticsDev1','开发商报送情况',31,32,'开发商报送情况'),
  (34,'颁发商品房预售许可证报送情况','images/plugin.gif','StatisticsDis1','颁发商品房预售许可证报送情况',32,32,'颁发商品房预售许可证报送情况'),
  (35,'商品住宅销售备案报送情况','images/plugin.gif','StatisticsDis2','商品住宅销售备案报送情况',33,32,'商品住宅销售备案报送情况'),
  (36,'商业营业房销售备案报送情况','images/plugin.gif','StatisticsDis3','商业营业房销售备案报送情况',34,32,'商业营业房销售备案报送情况'),
  (37,'办公房销售备案报送情况','images/plugin.gif','StatisticsDis4','办公房销售备案报送情况',35,32,'办公房销售备案报送情况'),
  (38,'其它房销售备案报送情况','images/plugin.gif','StatisticsDis5','其它房销售备案报送情况',36,32,'其它房销售备案报送情况'),
  (39,'在册私有住宅报送情况','images/plugin.gif','StatisticsDis6','在册私有住宅报送情况',37,32,'在册私有住宅报送情况'),
  (40,'二手住宅交易报送情况','images/plugin.gif','StatisticsDis7','二手住宅交易报送情况',38,32,'二手住宅交易报送情况');
COMMIT;
...
INSERT INTO `t_user` (`id`, `name`, `password`, `create_date`, `otherName`, `userType`) VALUES
  (-1,'superadmin','1','2013-08-30 01:06:00','222222222222',3),
  (1,'admin','1','2013-08-30 23:58:11','管理员',1),
  (3,'桥东区开发商','1','2013-08-30 20:37:06','111111',1),
  (4,'开发商阅览','1','2013-09-15 10:08:02','开发商阅览',3),
  (5,'管理员','1','2013-09-23 21:14:20','1',3),
  (6,'qdq','1','2013-10-25 21:10:56','桥东区',2),
  (7,'qxq','1','2013-10-25 21:12:50','桥西区',2),
  (8,'sa','a','2013-10-25 22:18:02','a',2),
  (9,'ss','1','2013-10-25 22:31:40','ss',2),
  (10,'11','1','2013-10-25 22:31:58','11',1),
  (11,'111','1','2013-10-25 22:32:52','1111',1),
  (12,'33','1','2013-10-25 22:37:56','33',1),
  (13,'gxq','1','2013-10-27 10:53:48','高新区',2);
COMMIT;
