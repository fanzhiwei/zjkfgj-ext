...
//            		params : {start:0, limit:15,recordYearMonth:queryDate}
				...
				proxy: new Ext.data.HttpProxy({
					url : 'district/listReport2_5?category=3&t=' + new Date().getTime()
				}),
                remoteSort: false,
        ...
        getForm: function() {
            var form = new Ext.form.FormPanel({
				url:'district/saveReport2_5?category=3',
                labelAlign: 'right',
                buttonAlign: 'center',
                ...
                },
                {
                	...
                	fieldLabel: '面积（㎡）',
	      	    	...
	      	    	listeners: {
	      	    		scope: this,
	      	    		change: function(e) {
	      	    			var tatalPriceLis = App.DistrictReport4.form.form.findField("totalPrice").getValue();
	      	    			var areaLis = App.DistrictReport4.form.form.findField("area").getValue();
	      	    			var averagePriceLis = tatalPriceLis*10000/areaLis;
	      	    			
	                    	if (tatalPriceLis == 0 || areaLis == 0) {
	                    		App.DistrictReport4.form.form.findField("averagePrice").setValue('0.00');
	                    	} else {
	                    		App.DistrictReport4.form.form.findField("averagePrice").setValue(Ext.util.Format.number(averagePriceLis, '0.00'));
	                    	}
	      	    		}
	      	    	}                
                },
...
//                layout: 'fit',
                ...
                tbar: [{
                    ...
                    listeners: {
                        ...
                        select: function(obj, date) {
                        	App.DistrictReport4.store.reload({params:{recordYearMonth:document.getElementById("queryDateReport4").value.replace("-","")}});
                        },
        ...
        add: function() {
            Ext.apply(this.currentFormValues, {
            	id:'',
            	recordYearMonth: document.getElementById("queryDateReport4").value.replace("-",""),
            	developerName:'',
            	projectName:'',
            	startTime:'',
            	completeTime:'',
						...
						Ext.Ajax.request({
							...
							success: function(resp, opts) {
								...
								if(result.success=='true') {
									Ext.Msg.alert('信息', info);
                                    App.DistrictReport4.store.reload();
								}else {
                                    Ext.Msg.alert('信息', info);
                                }
							},
